...
type AuctionItemForm = z.infer<typeof auctionItemSchema>
...
interface AuctionProps {
  ...
  onAddItem: (data: AuctionItemForm) => Promise<void>
  onDeleteItem: (id: string) => Promise<void>
  onUpdateItem: (id: string, data: Partial<AuctionItem>) => Promise<void>
}
...
export default function Auction({
  ...
  const form = useForm<AuctionItemForm>({
  ...
  const handleAddSubmit = async (data: AuctionItemForm) => {
  ...
  const { totalAmount, totalPaid, totalDue } = calculateSummary()
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-2 md:gap-4">
        ...
        <div className="bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl p-3 md:p-6 text-white shadow-lg">
        ...
        <div className="bg-gradient-to-r from-red-500 to-orange-500 rounded-xl p-3 md:p-6 text-white shadow-lg">
      ...
      <div className="bg-gradient-to-r from-white-50 to-white-50 rounded-lg p-4 border border-white-100">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm bg-white shadow-sm input-visible"
            />
          </div>
          <button
        ...
        <div className="bg-white input-visible rounded-lg p-6 shadow-lg border border-white/20">
          ...
          >
            <div>
              ...
              <input
                {...form.register('name')}
                className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white shadow-sm transition-all duration-200 input-visible"
            ...
            <div>
              ...
              {form.formState.errors.item && (
                <p className="mt-2 text-xs text-red-600 font-medium">{form.formState.errors.item.message}</p>
              )}
            </div>
            <div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-end gap-3 sm:col-span-2 lg:col-span-3 xl:col-span-6">
      ...
      <div className="bg-white/80 backdrop-blur-lg rounded-xl shadow-lg border border-white/20 overflow-hidden">
        ...
        <div className="hidden md:block">
          <div className="overflow-x-auto">
            <table className="w-full divide-y divide-gray-200/50 min-w-[1200px]">
              <thead className="bg-gradient-to-r from-gray-50/80 to-gray-100/80 backdrop-blur-sm">
                <tr>
                  <th className="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider min-w-[130px] border-r border-gray-200">Name</th>
                  <th className="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider min-w-[130px] border-r border-gray-200">Item</th>
                  ...
                  <tr>
                    <td colSpan={10} className="px-4 py-12 text-center text-gray-500 text-sm">
                      <div className="flex flex-col items-center space-y-3">
                        ...
                        <p className="font-medium">No auction items added yet</p>
                      ...
                      <tr key={item.id} className="hover:bg-blue-50/50 transition-colors duration-200">
                        <td className="px-3 py-4 text-sm font-medium text-gray-900 border-r border-gray-200">
                          {isEditing ? (
                            <input
                              ...
                              className="w-full px-2 py-1 border border-gray-300 rounded text-sm bg-white focus:ring-1 focus:ring-blue-500 focus:border-transparent input-visible"
                            />
                          ) : (
                        ...
                        <td className="px-3 py-4 text-sm text-gray-900 border-r border-gray-200">
                          {isEditing ? (
                            ...
                            <div className="truncate text-lg font-semibold text-blue-600" title={item.item}>{item.item}</div>
                          )}
                        </td>
                        <td className="px-3 py-4 text-sm font-semibold text-gray-900 border-r border-gray-200">
                          {isEditing ? (
                            ...
                            <div className="text-purple-600 font-bold">₹{item.amount}</div>
                          )}
                        </td>
                        <td className="px-3 py-4 text-sm font-semibold text-gray-900 border-r border-gray-200">
                          {isEditing ? (
        ...
        <div className="md:hidden">
          {items.length === 0 ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full divide-y divide-gray-200/50 min-w-[800px]">
                <thead className="bg-gradient-to-r from-gray-50/80 to-gray-100/80 backdrop-blur-sm">
                  <tr>
                    ...
                    <th className="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider min-w-[100px] border-r border-gray-200">Item</th>
                      ...
                      <tr key={item.id} className="hover:bg-blue-50/50 transition-colors duration-200">
                        <td className="px-2 py-3 text-sm border-r border-gray-200">
                          {isEditing ? (
                            <input
                              ...
                              value={editFormData?.name || ''}
                              onChange={(e) => handleEditFormChange('name', e.target.value)}
                              className="w-full px-1 py-1 border border-gray-300 rounded text-xs bg-white focus:ring-1 focus:ring-blue-500 focus:border-transparent input-visible"
                            />
                          ) : (
                        ...
                        <td className="px-2 py-3 text-sm border-r border-gray-200">
                          {isEditing ? (
                            ...
                            <div className="font-medium text-blue-600 truncate" title={item.item}>{item.item}</div>
                          )}
                        </td>
                        <td className="px-2 py-3 text-sm border-r border-gray-200">
                          {isEditing ? (
                            ...
                            <div className="font-semibold text-purple-600">{formatCurrency(item.amount)}</div>
                          )}
                        </td>
                        <td className="px-2 py-3 text-sm border-r border-gray-200">
                          {isEditing ? (
